      ...
      <div className="@container max-w-1200px mx-auto">
        <div className="flex flex-col gap-10 @[864px]:flex-row items-center">
          <div
            ...
            style={{
              backgroundImage: 'url("/AboutHerosection.webp")',
            }}
          />
          <div className="flex flex-col gap-8 @[864px]:w-1/2 @[864px]:pl-12">
            ...
            <div className="flex gap-4">
              <Link
                to="/products"
                className="flex min-w-160px items-center justify-center rounded-full h-14 px-8 bg-primary text-white text-base font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 cursor-pointer"
              >
                Explore Products
              </Link>
            </div>
